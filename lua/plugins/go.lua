...
require("go").setup({
	...
	-- max_line_len = 140, -- max line length in golines format, Target maximum line length for golines
	...
	gopls_cmd = "--version", -- if you need to specify gopls path and cmd, e.g {"/home/user/lsp/gopls", "-logfile","/var/log/gopls.log" }
	gopls_remote_auto = fasle, -- add -remote=auto to gopls
	gocoverage_sign = "█",
